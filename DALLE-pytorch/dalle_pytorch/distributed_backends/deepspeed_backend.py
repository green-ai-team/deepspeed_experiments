...
#         self.backend_module.init_distributed()
        # this is what happend inside deepspeed.init_distributed()
#         if not torch.distributed.is_initialized():
    ...
    #                                              init_method=init_method)
        ...
        print('Init Method:', init_method, flush=True)
        print('WorldSize: ', world_size, flush=True)
        print('Rank: ', rank, flush=True)
        # or: self.backend_module.init_distributed(auto_mpi_discovery=True, init_method=init_method)
